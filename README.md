...
5. Probar los endpoints: `/pokemon` y `/pokemon/:identifier` en `localhost:3000` (host por defecto) (reemplazar :identifier por algún nombre de Pokémon)